...
public class Triangle {
	...
	/*
	 * private Point point1; private Point point2; private Point point3;
	 * 
	...
	public void draw() {
		...
		/*
		 * System.out.println("Point1(" + getPoint1().getX() + " , " +
		 * getPoint1().getY()+")"); System.out.println("Point2(" +
		 * getPoint2().getX() + " , " + getPoint2().getY()+")");
		 * System.out.println("Point3(" + getPoint3().getX() + " , " +
		 * getPoint3().getY()+")");
		 */
